...
export default function CardsResumo({ totalAtual, totalAnterior, voceDeVe, periodo }) {
  ...
  let detalheVariacao = 'sem período anterior'
  if (temComparacao && gastouMenos) {
    classeVariacao = styles.positivo
    textoVariacao = `${Math.round(variacaoPct)}%`
    detalheVariacao = 'vs período anterior'
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <span className={styles.detalhe}>{detalheVariacao}</span>
      </div>
